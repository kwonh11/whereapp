...
const KAKAO_URL = "https://open.kakao.com/o/gosUv2xc";
const GITHUB_URL = "https://github.com/kwonh11/newsmart.git";
...
export default function Footer() {
    ...
    return (
    <React.Fragment>
        <Snackbar open={copied} onClose={handleCloseSnackbar} anchorOrigin={{vertical:'bottom', horizontal:'center'}}>
            <Alert onClose={handleCloseSnackbar} severity="success" variant="filled" style={{fontWeight:"bold"}}>
                COPIED!!
            </Alert>
        </Snackbar>
        <FooterContainer>
            <IconContainer>
                <CopyToClipboard text={"kwonh11@gmail.com"} onCopy={handleCopyEmail}>
                    <StyledButton>
                        <Avatar>
                            {/* 메일 아이콘 */}
                            <MailIcon />
                ...
                <StyledButton onClick={() => handleClickAvatar(KAKAO_URL)}>
                    <Avatar>
                        {/* 카카오 아이콘 */}
                        <SvgIcon>
                ...
                <StyledButton onClick={() => handleClickAvatar(GITHUB_URL)}>
                    <Avatar>
                        {/* 깃허브 아이콘 */}
                        <SvgIcon>
